...
namespace xorsat {
    ...
    class SolverImplementation : public Solver {
        ...
        /** converts a disjunction to a xor-clause and adds it to
          the set of pending xor-clauses */
        void addPendingXor(const Disjunction& d);
    public:
#ifdef DEBUG
        ...
        const std::vector<Literal>& getImplications() const;
        ...
        long long getEvenParityEliminated() const {
            return implGraph.getEvenParityEliminated();
        }
